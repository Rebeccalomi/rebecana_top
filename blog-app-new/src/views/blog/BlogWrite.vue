      ...
      <el-dialog title="摘要 分类 标签"
        ...
        <el-form :model="articleForm" ref="articleForm" :rules="rules">
          ...
          <el-form-item label="是否置顶" prop="weight">
            <el-select v-model="articleForm.weight" placeholder="是否置顶">
              <el-option label="是" value="1"></el-option>
              <el-option label="否" value="0"></el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="导航图片" prop="titleimg">
              <el-upload
                class="upload-picture"
                action="http://localhost:8888/upload/update"
...
<script>
  ...
  import {publishArticle, viewArticle} from '@/api/article'
  ...
  export default {
    ...
    methods: {
      ...
      handleSuccess (response, file, fileList) {
        this.articleForm.titleimg = response.data
        this.$message.success(this.articleForm.titleimg)
        this.imageUrl = this.articleForm.titleimg;
      },
      getArticle(id){
        let that = this
        viewArticle(id).then(data => {
        ...
        this.$refs[articleForm].validate((valid) => {
          if (valid) {
            ...
            let article = {
              ...
              titleimg: this.articleForm.titleimg
            }
